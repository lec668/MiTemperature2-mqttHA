...
def myMQTTPublish(topic,jsonMessage):
	...
	if not mqttJSONDisabled:
		...
		print("myMQTTPublish:",jsonMessage)


def haMQTTPublish(topic,jsonMessage):
	if not mqttJSONDisabled:
		MQTTClient.publish(topic,jsonMessage1,1)
	...
	def handleNotification(self, cHandle, data):
		...
		try:
			...
			if(args.mqttconfigfile):
				...
				jsonstr1 = '{"device_class": "temperature", "name": "' + measurement.sensorname + '_temp", "unique_id": "lywsd03mmc_' + measurement.sensorname + '_temp", "device": { "name":"lywsd03mmc_' + measurement.sensorname + '", "identifiers": "lywsd03mmc_' + measurement.sensorname + '", "model": "LYWSD03MMC", "manufacturer": "Xiaomi"}, "state_topic": "' + MQTTTopic + '/sensor/' + measurement.sensorname + '/state", "unit_of_measurement": "°C", "value_template": "{{ value_json.temperature}}","platform": "mqtt" }'

				jsonstr2 = '{"device_class": "humidity", "name": "' + measurement.sensorname + '_humi", "unique_id": "lywsd03mmc_' + measurement.sensorname + '_humi", "device": { "name":"lywsd03mmc_' + measurement.sensorname + '", "identifiers": "lywsd03mmc_' + measurement.sensorname + '", "model": "LYWSD03MMC", "manufacturer": "Xiaomi"}, "state_topic": "'+ MQTTTopic + '/sensor/' + measurement.sensorname + '/state", "unit_of_measurement": "%", "value_template": "{{ value_json.humidity}}","platform": "mqtt" }'

				jsonstr3 = '{"device_class": "battery", "name": "' + measurement.sensorname + '_batt", "unique_id": "lywsd03mmc_' + measurement.sensorname + '_batt", "device": { "name":"lywsd03mmc_' + measurement.sensorname + '", "identifiers": "lywsd03mmc_' + measurement.sensorname + '", "model": "LYWSD03MMC", "manufacturer": "Xiaomi"}, "state_topic": "'+ MQTTTopic + '/sensor/' + measurement.sensorname + '/state", "unit_of_measurement": "%", "value_template": "{{ value_json.batterylevel}}","platform": "mqtt" }'

				jsonstr4 = '{"device_class": "voltage", "name": "' + measurement.sensorname + '_volt", "unique_id": "lywsd03mmc_' + measurement.sensorname + '_volt", "device": { "name":"lywsd03mmc_' + measurement.sensorname + '", "identifiers": "lywsd03mmc_' + measurement.sensorname + '", "model": "LYWSD03MMC", "manufacturer": "Xiaomi"}, "state_topic": "'+ MQTTTopic + '/sensor/' + measurement.sensorname + '/state", "unit_of_measurement": "v", "value_template": "{{ value_json.batteryvoltage}}","platform": "mqtt" }'

				jsonstr5 = '{ "temperature": ' + str(measurement.temperature) + ', "humidity": ' + str(measurement.humidity) + ', "batteryvoltage" : ' + str(measurement.voltage) + ', "batterylevel": ' + str(measurement.battery) + ' }'
				...
				topic1 = MQTTTopic + "/sensor/" + measurement.sensorname + "_temp/config"
				topic2 = MQTTTopic + "/sensor/" + measurement.sensorname + "_humi/config"
				topic3 = MQTTTopic + "/sensor/" + measurement.sensorname + "_battlevel/config"
				topic4 = MQTTTopic + "/sensor/" + measurement.sensorname + "_battvolt/config"
				topic5 = MQTTTopic + "/sensor/" + measurement.sensorname + "/state"
				...
				MQTTClient.publish(topic1,jsonstr1,1)
				MQTTClient.publish(topic2,jsonstr2,1)
				MQTTClient.publish(topic3,jsonstr3,1)
				MQTTClient.publish(topic4,jsonstr4,1)
				MQTTClient.publish(topic5,jsonstr5,1)
